...
urlpatterns = [
    ...
    path("todos/<int:pk>/complete/",views.TodoCompleteView.as_view(),name="todo-complete"),
    ...
    path("employees/remove/",crm_views.EmployeeDeleteView.as_view(),name="emp-delete"),
    path("employees/<int:pk>/edit/",crm_views.EmployeeEditView.as_view(),name="emp-edit"),
